...
- No page fetched this pass confirmed the exact 5.x menu bar contents (File/View/Contacts/Conversations/Call/Tools/Help), the profile editor's mood-message/avatar/Skype Name layout, or tray-icon right-click menu specifics; these remain unsourced open questions (see below).
...
- Exact menu bar contents (File, View, Contacts, Conversations, Call, Tools, Help) for the Skype 5.x main window were not confirmed with a verbatim source this run.
