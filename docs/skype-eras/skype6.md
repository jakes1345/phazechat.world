...
- Skype 6.0.0.120 for Windows was released October 24, 2012, with a Windows 8 "Metro" companion version [6].
...
- Skype 6.0 let users sign in directly with a Facebook or Microsoft account instead of only a Skype account; a Live Messenger, Hotmail, or Outlook.com account already qualified as a compatible Microsoft account [6].
...
- Skype 6.14 added new hidden/concealed emoticons: (talktothehand), (dog), (shielddeflect), (idea), (sheep), (blackwidow), (bike), (nickfury), (bucky), (cat), (captain) [9].
...
- "Skype 6.14 released 19 February 2014 with Marvel-themed hidden emoticons later pulled by 6.20": sourced only to a second page on the same chat4o.com domain family, not an independent outlet. Unresolved [21].
...
- Source unreachable: the desktop version of Skype for Windows and Mac was released in October 2012, distinct from the Windows 8 Metro app [2].
- Source unreachable: after merging a Microsoft Account with a Skype Account, users received all their Messenger contacts alongside existing Skype contacts [2].
- Source unreachable: Tools > Options > Advanced in Skype 6.x contained a "Help improve Skype..." telemetry checkbox [2].
- Source unreachable: the last Skype version usable on Windows XP was 7.36.0.150 [5].
- Source unreachable: group video calling for up to 10 people was made free on Mac, Windows, and Xbox One (Forbes duplicate of the TechCrunch claim) [12].
- Source unreachable: Skype's own emoticons FAQ page, which would corroborate the "72 emoticons" figure [20].
- Source unreachable: chat4o.com's page specifically on Skype 6.14's release date and Marvel-themed emoticon removal [21].
- Source unreachable: Wikipedia's cited 2019 Skype blog post on the 50-person group-call cap [22].
...
2. https://www.ghacks.net/2012/10/24/skype-6-released/ — secondary (unreachable, 403)
...
21. https://en.chat4o.com/skype-6-14/ — secondary (unreachable; same domain as source 9, not independent)
